...
def def_happiness_point(student_final_ranklist,company_final_ranklist):
	happiness_point=[]
	for i in range(0,50):
		happiness_point.append((student_final_ranklist[i][0],company_final_ranklist[14][0]))

	for i in range(1,17):
		for j in range(0,50):
			happiness_point.append((student_final_ranklist[50*i+j][0],company_final_ranklist[14+i*15][0]))

	for i in range(850,1000):
		happiness_point.append((student_final_ranklist[i][0],company_final_ranklist[299][0]))
...
def make_seq_stud_pref_list(company_final_ranklist, student_final_ranklist):
	...
	for i in range(0,len(student_final_ranklist)):
		...
		seq_part=[]
		non_seq_part=[]
		seq_part=company_order[i/(10/3):len(company_order)]
		non_seq_part=company_order[0:i/(10/3)]
...
# 	plt.show()
	...
	fig, ax = plt.subplots()
	rects1 = ax.bar(ind + 1.5*width, rank_eff_normal_sum/1000, width, color='grey',edgecolor='black', hatch=".")
	rects2 = ax.bar(ind + 2.5*width, rank_eff_dream_sum/1000, width, color='grey', hatch="*")
	rects3 = ax.bar(ind + 3.5*width, rank_eff_normal_spc_sum/1000, width, color='grey', hatch="X")
	rects4 = ax.bar(ind + 4.5*width, rank_eff_dream_spc_sum/1000, width, color='grey', hatch="o")

	# add some text for labels, title and axes ticks
	ax.set_ylabel('Average Rank Efficiency')
	...
	#Fairness
	N = 4
	avggain=(avg_gain_normal_sum/1000, avg_gain_dream_sum/1000, avg_gain_normal_spc_sum/1000, avg_gain_dream_spc_sum/1000)
	highestgain=(highest_gain_normal_sum/1000, highest_gain_dream_sum/1000, highest_gain_normal_spc_sum/1000, highest_gain_dream_spc_sum/1000)
	highestloss=(-highest_loss_normal_sum/1000, -highest_loss_dream_sum/1000, -highest_loss_normal_spc_sum/1000, -highest_loss_dream_spc_sum/1000)
	ind = np.arange(N)  # the x locations for the groups
	...
	fig, ax = plt.subplots()
	rects1 = ax.bar(ind + width, ((happiness_index_normal_sum)*100)/1000, width, color='dimgray')
	rects2 = ax.bar(ind + 2*width, (happiness_index_dream_sum*100)/1000, width, color='darkgray')
	rects3 = ax.bar(ind + 3.5*width, (happiness_index_normal_spc_sum*100)/1000, width, color='lightgray')
	rects4 = ax.bar(ind + 4.5*width, (happiness_index_dream_spc_sum*100)/1000, width, color='tan')
	...
	fig, ax = plt.subplots()
	rects1 = ax.bar(ind + width, blocking_pairs_normal_sum/1000, width, color='dimgray')
	rects2 = ax.bar(ind + 2*width, blocking_pairs_dream_sum/1000, width, color='darkgray')
	rects3 = ax.bar(ind + 3.5*width, blocking_pairs_normal_spc_sum/1000, width, color='lightgray')
	rects4 = ax.bar(ind + 4.5*width, blocking_pairs_dream_spc_sum/1000, width, color='tan')
	...
	fig, ax = plt.subplots()
	rects1 = ax.bar(ind + width, companies_disappointed_normal_sum/1000, width, color='dimgray')
	rects2 = ax.bar(ind + 2*width, companies_disappointed_dream_sum/1000, width, color='darkgray')
	rects3 = ax.bar(ind + 3.5*width, companies_disappointed_normal_spc_sum/1000, width, color='lightgray')
	rects4 = ax.bar(ind + 4.5*width, companies_disappointed_dream_spc_sum/1000, width, color='tan')
	...
	fig, ax = plt.subplots()
	rects1 = ax.bar(ind + width, total_st_placed_normal_sum/1000, width, color='dimgray')
	rects2 = ax.bar(ind + 2*width, total_st_placed_dream_sum/1000, width, color='darkgray')
	rects3 = ax.bar(ind + 3.5*width, total_st_placed_normal_spc_sum/1000, width, color='lightgray')
	rects4 = ax.bar(ind + 4.5*width, total_st_placed_dream_spc_sum/1000, width, color='tan')
	...
	rects2 = ax.bar(ind + 2*width, oldies_placement_sum/1000, width, color='darkgray')
	rects3 = ax.bar(ind + 3.5*width, 0, width, color='lightgray')
	rects4 = ax.bar(ind + 4.5*width, oldies_placement_spc_sum/1000, width, color='tan')
