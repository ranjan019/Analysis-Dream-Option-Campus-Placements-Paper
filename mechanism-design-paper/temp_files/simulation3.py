...
def find_stability(student_selected_list,stud_pref_list):
	...
	return float(float(blocking_pairs)/float(len(student_selected_list)))
...
# 	plt.show()
	...
	print ("rank_eff_normal_spc::",rank_eff_normal_spc)
	print
	print ("rank_eff_dream_spc::",rank_eff_dream_spc)
	...
	# fig, ax = plt.subplots()
	# rects1 = ax.bar(ind + width, rank_eff_normal_sum/1000, width, color='dimgray')
	# rects2 = ax.bar(ind + 2*width, rank_eff_dream_sum/1000, width, color='darkgray')
	# rects3 = ax.bar(ind + 3.5*width, rank_eff_normal_spc_sum/1000, width, color='lightgray')
	# rects4 = ax.bar(ind + 4.5*width, rank_eff_dream_spc_sum/1000, width, color='tan')
	...
	# fig, ax = plt.subplots()
	# rects1 = ax.bar(ind + width, (happiness_index_normal_sum)/10, width, color='dimgray')
	# rects2 = ax.bar(ind + 2*width, happiness_index_dream_sum/10, width, color='darkgray')
	# rects3 = ax.bar(ind + 3.5*width, happiness_index_normal_spc_sum/10, width, color='lightgray')
	# rects4 = ax.bar(ind + 4.5*width, happiness_index_dream_spc_sum/10, width, color='tan')
